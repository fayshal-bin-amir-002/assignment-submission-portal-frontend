...
export const getAllSubmissions = async (id: string) => {
  try {
    const res = await fetch(
      `${process.env.BASE_API}/submission/assignment/${id}`,
      {
        method: "GET",
        headers: {
...
export const feedBackSubmission = async (payload: FieldValues, id: string) => {
  try {
    const res = await fetch(`${process.env.BASE_API}/submission/${id}/status`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        Authorization: (await cookies()).get("accessToken")!.value,
...
export const createSubmission = async (payload: FieldValues) => {
  try {
    const res = await fetch(`${process.env.BASE_API}/submission`, {
      method: "POST",
      headers: {
        "Content-Type": "application/json",
        Authorization: (await cookies()).get("accessToken")!.value,
...
export const getMySubmissions = async (id: string) => {
  try {
    const res = await fetch(`${process.env.BASE_API}/submission/${id}`, {
      method: "GET",
      headers: {
        "Content-Type": "application/json",
        Authorization: (await cookies()).get("accessToken")!.value,
